            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link text-white" href="{{ url('informaciones') }}">Información</a>
                        </li> --}}

                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ url('residuos') }}">Residuos</a>
                        </li>
                        @if(Auth::user()->cedula=='1722352695')
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ url('reporte') }}">Rep-Usuarios</a>
                        </li>
                        @endif
                    </ul>
                    @endauth
