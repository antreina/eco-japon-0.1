...
<html lang="en">
  <head>
    ...
    <style>
       .gradient {
        background: linear-gradient(90deg, #1b0220 0%, #f6c32c 100%);
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    <!--Nav-->
    <div class="fixed w-full z-30 top-0 text-white bg-purple-900 ">
        Eco-Japon
      </div>
      
    <nav id="header" class="fixed w-full py-6 z-30 top-0 text-purple-900">
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div class="pl-4 flex items-center">
          <img src="imagen\0001.png" alt="logo" style="width:10%">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            ...
            @auth
            <li class="nav-item">
                <a class="inline-block py-2 px-4 text-black font-bold no-underline " href="{{ url('/home') }}">{{ __('Dashboard') }}</a>
            </li>
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <br>
          <p class="uppercase tracking-loose w-full">Reciclaje de residuos electrónicos</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Sabes que es el reciclaje de residuos electrónicos!
          </h1>
          <p class="leading-normal text-2xl mb-8">
            El reciclaje de residuos electrónicos es un proceso importante para el medio ambiente, 
            ya que estos desechos contienen materiales tóxicos y peligrosos que pueden causar daños
            a la salud humana y al medio ambiente si no se eliminan correctamente.
          </p>
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50 ml-40" style="width:70%" src="{{asset('imagen/0101.png')}}"/>
        </div>
      </div>
    </div>
    ...
    <section class="bg-white border-b py-8">
      <div class="container max-w-5xl mx-auto m-8">
        <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-purple-900">
          Eco-Japón
        </h2>
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <h4 class="text-gray-600 mb-8 font-bold">
              Como estudiantes del Instituto Tecnológico Superior sede Quito hemos visto la necesidad
              de implementar una nueva iniciativa para promover la educación ambiental entre sus 
              estudiantes a través de la ludificación de conocimientos sobre el reciclaje de residuos
              tecnológicos. Para ello, se desarrolló esta aplicación web.
              ECO-JAPON tiene como objetivo enseñar a los estudiantes a reciclar
              de manera adecuada los residuos tecnológicos y reducir su impacto en
              el medio ambiente.
              <br />
              <br />
          ...
          <div class="w-full sm:w-1/2 p-6">
            <img src="imagen\002.png" alt="logo" style="width:75% "class="mx-auto">
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <img src="imagen\004.png" alt="logo" style="width:120% "class="mx-auto">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              <h3 class="text-3xl text-gray-900 font-bold leading-none mb-3">
                Misión
              </h3>
              <p class="text-gray-600 mb-8 font-bold">
                Dar a Conocer a través de tips el proceso y correcta manipulación de los residuos 
                electrónicos y conjuntamente con la comunidad educativa ser el instituto más innovador en los
                procesos de reciclaje a nivel de educación superior.
                <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                  Visión
                </h3>
                <p class="text-gray-600 mb-8 font-bold">
                  El propósito de Eco-Japon es que mediante la utilización de la web los estudiantes
                  del instituto Japón, podrán realizar un ejercicio práctico en casa el cual ayude a identificar
                  los residuos tecnológicos que pueden afectar a salud y ayudar al cuidado del medio ambiente.
                <br />
                <br />
                {{-- Images from:
    ...
    <section class="bg-white border-b py-8">
      <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
          REGLA DE LAS 3 R
          <br>
          <img src="imagen\020.png" alt="logo" style="width:10% "class="mx-auto">
        </h2>
        {{-- <div class="w-full mb-4">
          <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
        </div> --}}
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink ">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <div class="w-full font-bold text-xl text-purple-900 px-6">
                <img src="imagen\recicle.png" alt="logo" style="width:45% "class="mx-auto">
                <br>
                RECICLAR
              </div>
              <p class="text-purple-900 font-bold text-base px-6 mb-5 ">
                Esta regla se enfoca en el reciclaje de los materiales que no se pueden reducir o reutilizar.
                Por ejemplo, se pueden reciclar envases de plástico, latas, papel y cartón.
                Es importante recordar que para reciclar correctamente, es necesario separar 
                los materiales adecuadamente y colocarlos en los contenedores de reciclaje correspondientes.
              </p>
            </a>
          </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <div class="w-full font-bold text-xl text-purple-900 px-6">
                <img src="imagen\reduce.png" alt="logo" style="width:48% "class="mx-auto">
                <br>
                REDUCIR
              </div>
              <p class="text-purple-800 font-bold text-base px-6 mb-5">
                Esta regla se enfoca en la reducción de la cantidad de residuos generados,
                especialmente aquellos que son difíciles de reciclar. Por ejemplo,
                se puede reducir el uso de productos de un solo uso, llevar bolsas 
                reutilizables al supermercado y usar contenedores recargables para almacenar alimentos y bebidas.
              </p>
            </a>
          </div>
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <div class="w-full font-bold text-xl text-purple-900 px-6 ">
                <img src="imagen\reuse.png" alt="logo" style="width:45% "class="mx-auto">
                 <br>
                REUTILIZAR
              </div>
              <p class="text-purple-900 font-bold text-base px-6 mb-5 ">
                Esta regla se enfoca en la reutilización de los productos o materiales existentes antes de desecharlos.
                Por ejemplo, se puede reutilizar los envases de vidrio para almacenar otros productos, 
                reparar electrodomésticos en lugar de comprar nuevos y donar ropa y juguetes en buen estado en lugar de desecharlos.
              </p>
            </a>
          </div>
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      <img src="imagen\003.png" alt="logo" style="width:15% "class="mx-auto">
